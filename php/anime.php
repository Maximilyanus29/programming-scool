		...
		<section class="course-page">
			...
			<div class="welcome">
				<div class="text">
					...
					<p class="description">Ребенок изучит академические основы композиции, колористики, свето-тени. Научится рисовать пропорции человека, позы в статике, динамике и перспективе. Узнает, как отображать эмоции персонажа. Разовьет креативное мышление и генерацию новых идей. Научится создавать индивидуальные интересные проекты в стиле Аниме.</p>
					<div class="location">
						<div class="img"><img src="img/coolicon (5).svg" alt=""></div>
						<div class="text-location">м Ленинский проспект</div>
					</div>
					<p class="date">15.08-26.08</p>
