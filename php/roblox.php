		...
		<section class="course-page">
			...
			<div class="welcome">
				<div class="text">
					...
					<p class="description">В результате обучения дети изучат программирование на языке LUA, создадут совместный проект и опубликуют его на всемирном портале компании Roblox.</p>
					<div class="location">
						<div class="img"><img src="img/coolicon (5).svg" alt=""></div>
						<div class="text-location">м. Спортивная</div>
					</div>
					<p class="date">20.06-01.07</p>
