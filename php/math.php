		...
		<section class="course-page">
			...
			<div class="welcome">
				<div class="text">
					...
					<p class="description">Дети познакомятся с устройством компьютера и с основными рабочими программами, применяемые в школьном обучении. Узнают, как безопасно пользоваться интернетом и научатся уверенно пользоваться клавиатурой и мышкой.</p>
					<div class="location">
						<div class="img"><img src="img/coolicon (5).svg" alt=""></div>
						<div class="text-location">м Хамовники, Ленинский проспект, Шелепиха</div>
					</div>
