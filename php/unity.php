		...
		<section class="course-page">
			...
			<div class="welcome">
				<div class="text">
					...
					<p class="description">Ребенок получит практические навыки профессионального разработчика игровых приложений и создаст собственный проект. Узнает о том, какие передовые технологии используются в современной космической отрасли и как они связаны с программированием. Познакомится с перспективами профессионального развития в космической индустрии.</p>
					<div class="location">
						<div class="img"><img src="img/coolicon (5).svg" alt=""></div>
						<div class="text-location">м Спортивная</div>
					</div>
					<p class="date">18.07-29.07</p>
